...
import { VisionArchitectClient } from "@/components/scan/visionArchitechClient";
...
export const metadata: Metadata = {
    title: "Vision Architect | Registry | SchoolPaaS",
    description: "AI-powered digitization of physical examination papers into registry nodes."
};
...
export default async function Page() {
    ...
    // 2. Fetch grade subjects to populate the Topic Selector (Rule 7)
    ...
    return (
        <VisionArchitectClient 
            userId={profile.id}
            schoolId={profile.schoolId}
            userRole={profile.role}
            gradeSubjects={gradeSubjects as any}
        />
    );
}