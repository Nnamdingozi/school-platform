...
export function DashboardHeader({ 
  ...
  const scrollToOrNavigate = (target: string) => {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b bg-background px-4 md:px-6 sticky top-0 z-30 shadow-sm">
      <div className="flex items-center gap-4 md:gap-8">
        <h1 className="text-lg font-bold tracking-tight md:text-xl">
          Welcome, {teacherName}
        </h1>
      ...
      <div className="flex items-center gap-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuItem onClick={() => scrollToOrNavigate("#ai-planner")}>
              <BookOpen className="mr-2 h-4 w-4 text-amber-600" />
              <span>Generate AI Lesson</span>
            </DropdownMenuItem>
            
            <DropdownMenuItem onClick={() => scrollToOrNavigate("#performance-section")}>
              <Plus className="mr-2 h-4 w-4 text-blue-600" />
              <span>Assessments & Data</span>
            </DropdownMenuItem>
            
            <DropdownMenuItem onClick={() => scrollToOrNavigate("/reports")}>
              <FileText className="mr-2 h-4 w-4 text-emerald-600" />
            ...
            <DropdownMenuItem onClick={() => scrollToOrNavigate("/students")}>
              <Users className="mr-2 h-4 w-4 text-muted-foreground" />
              <span>Class Directory</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
