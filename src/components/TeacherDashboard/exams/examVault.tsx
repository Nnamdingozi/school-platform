...
//             className="w-full bg-slate-950 border border-white/10 py-4 roun ded-2xl text-[10px] font-black uppercase text-slate-400 hover:text-school-primary transition-all flex items-center justify-center gap-2"
//           >
