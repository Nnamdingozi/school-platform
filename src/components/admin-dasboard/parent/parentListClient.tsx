...
//     initialParents: UserListItem[];
// }

// /**
//  * INSTITUTIONAL PARENT REGISTRY (Tier 2)
...
//                                 {initialParents.length} registered family accounts.
//                             </p>
//                         </div>
//                     </div>
...
//                         className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-school-primary text-slate-950 font-black text-[10px] uppercase tracking-widest transition-all hover:scale-105 shadow-xl shadow-school-primary/10"
...
//                         placeholder="SEARCH BY IDENTITY OR CONTACT METADATA..."
            ...
            <div className="max-w-7xl mx-auto p-4 md:p-8 lg:p-12 space-y-10 md:space-y-16">
                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-border pb-10">
                    <div className="flex items-center gap-5">
                        ...
                        <div className="h-16 w-16 rounded-2xl border border-school-primary/20 bg-school-primary/10 flex items-center justify-center shadow-lg transition-colors">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-[10px] font-semibold uppercase tracking-widest mt-2 flex items-center gap-2">
                                ...
                                {initialParents.length} Identity Nodes Discovered
                            </p>
                        </div>
                    </div>
